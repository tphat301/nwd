<?php
	...
	$requick = array(
		...
		/* Quy trình thiết kế */
		array("tbl" => "news", "field" => "id", "source" => "news", "com" => "quy-trinh-thiet-ke", "type" => "quy-trinh-thiet-ke", "menu" => true),
	...
	switch($com)
	{
		...
		case 'quy-trinh-thiet-ke':
			$source = "news";
			$template = isset($_GET['id']) ? "news/news_detail" : "news/news";
			$seo->set('type',isset($_GET['id']) ? "article" : "object");
			$type = $com;
			$titleMain = quytrinhthietke;
			break;
